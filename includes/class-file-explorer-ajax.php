...
class File_Explorer_Ajax {
    ...
    private function init_hooks() {
        ...
        add_action('wp_ajax_file_explorer_frontend_get_file_link', array($this, 'get_file_link'));
        add_action('wp_ajax_nopriv_file_explorer_frontend_get_file_link', array($this, 'get_file_link'));
    }
